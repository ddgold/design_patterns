...
public class CycleWorkSpace extends  WorkSpace {
    ...
    public static final int _GRAY  = 1;
    ...
    public void preVisitAction( Vertex v ) {
        ...
        { // if it has not been visited then set the
            ...
            v.VertexColor = _GRAY; // we make the vertex gray
        }
    }

    public void postVisitAction( Vertex v ) 
      {
        v.VertexColor = _BLACK; // we are done visiting so make it black
        counter--;
    } // of postVisitAction
    ...
    public void checkNeighborAction( Vertex vsource, 
                     Vertex vtarget ) 
      {
        ...
        if ( isDirected )
        {
            if ( ( vsource.VertexColor == _GRAY ) && ( vtarget.VertexColor == _GRAY ) ) 
              {
                AnyCycles = true;
            }
        }
